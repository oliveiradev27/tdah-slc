...
<header>
    <nav role="custom-dropdown">
        ...
        <label for="button" onclick><div class="Link icon_p" ><a href="javascript:window.history.go(-1)">Aplicação</a></div></label>
        <div class="linkPainel icon_p" ><a href="javascript:window.history.go(-1)">Aplicação</a></div>
        <ul>
...
<section>
    <article>
        ...
        <ul class="menuCenter">
            <li><a href="../tmp/pedagogia"><img src="../img/icon_ped.png" /></a></li>
            <li class="trans"><a ><img src="../img/icon_cog.png"  /></a></li>
            <li class="trans"><a ><img src="../img/icon_afe.png" /></a></li>
            <li class="trans"><a ><img src="../img/icon_psi.png" /></a></li>
