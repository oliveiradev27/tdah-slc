...
<header>
    <nav role="custom-dropdown">
        ...
        <label for="button" onclick><div class="Link icon_p" ><a href="javascript:window.history.go(-1)">Avaliação</a></div></label>
        <div class="linkPainel icon_p" ><a href="javascript:window.history.go(-1)">Avaliação</a></div>
        <ul>
...
<ul class="menuCenter painel">
    <li class="icons icons_ped Tam"><a href="../tmp/ava_pedagogia.php">Pedagógia</a></li>
    <li class="icons icons_a clearCor Tam"><a>Cognitivo</a></li>
    <li class="icons icons_af clearCor Tam"><a>Afetivo</a></li>
    <li class="icons icons_ps clearCor Tam"><a>Psicomotor</a></li>
</ul>
