...
<header>
    <nav role="custom-dropdown">
        ...
        <label for="button" onclick><div class="Link icon_p" ><a href="javascript:window.history.go(-1)">Stand by 10</a></div></label>
        <div class="linkPainel icon_p" ><a href="javascript:window.history.go(-1)">Stand by 10</a></div>
        <ul>
