    ...
    <article>
        ...
        <div class="boxMain">
            <form name="ava_pac" method="post" action="avaliacao.php" >
                ...
                <div class="ClearBox"></div>
                <h3> Avaliação:</h3>
                <input type="text" name="categoria" class="tmp_p tmp_small tmp_bg" value="Não Adequada" >
                <div class="Clear"></div>
                <h3> </h3><textarea>Silabada, Não lê, Inverte palavras, Omite letras</textarea>
                <h3> Observação:</h3>
                <textarea>Nenhuma</textarea>
                <div class="ClearBox"></div>
